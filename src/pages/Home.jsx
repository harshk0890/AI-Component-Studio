...
const Home = () => {
 ...
 const Home = () => {
  ...
  const ai = new GoogleGenAI({
    apiKey: "AIzaSyCDuuxlOtth--3dDkSrkgmxqSoKPXsYOjc"
  });
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 lg:px-16">
        ...
        <div className="w-full py-6 rounded-xl bg-[#141319] mt-5 p-5">
          <h3 className='text-[25px] font-semibold sp-text'>AI Component Studio</h3>
          <p className='text-gray-400 mt-2 text-[16px]'>Just describe it — AI handles the coding.</p>
          ...
          <p className='text-[15px] font-[700] mt-5'>Sketch it with words</p>
          <textarea
            ...
            placeholder="Detail your design, and AI turns it into code..."
          ></textarea>

          <div className="flex items-center justify-between mt-3">
            <p className='text-gray-400 text-sm'>Generate your code with a click!</p>
            <button
              onClick={getResponse}
        ...
        <div className="relative mt-2 w-full h-[80vh] bg-[#141319] rounded-xl overflow-hidden">
          {
            !outputScreen ? (
              <div className="w-full h-full flex items-center flex-col justify-center">
                ...
                <p className='text-[16px] text-gray-400 mt-3'>Your AI-generated component & code will display here..</p>
              </div>
            ) : (
              <>
                {/* Tabs */}
